...
// checks if the LayoutVersion type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LayoutVersion{}
...
type _LayoutVersion LayoutVersion
...
func (o LayoutVersion) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["version"] = o.Version
	return toSerialize, nil
}

func (o *LayoutVersion) UnmarshalJSON(data []byte) (err error) {
	...
	varLayoutVersion := _LayoutVersion{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varLayoutVersion)

	if err != nil {
		return err
	}

	*o = LayoutVersion(varLayoutVersion)
